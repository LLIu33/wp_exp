			...
			<tr class="tribe-tickets-meta-row">
				<td colspan="4" class="tribe-tickets-attendees">
					<table>
						...
						<tr class="tribe-tickets-seats-row">
							<td>
								<label for="tribe-tickets-seats"><?php esc_html_e( 'seats:', 'event-tickets' ); ?></label>
							</td>
							<td colspan="3">
								<input type="text" name="attendee[seats]" id="tribe-tickets-seats">
							</td>
						</tr>
					</table>
				</td>
